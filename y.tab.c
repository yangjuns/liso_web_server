...
{
       0,   108,   108,   109,   110,   114,   119,   145,   146,   147,
     148,   154,   159,   168,   172,   176,   181,   189,   209,   210,
     213
};
#endif
...
{
      39,   -22,   -22,   -22,   -22,     9,    39,    21,    27,   -22,
      -3,   -22,    36,   -22,   -22,   -22,   -22,   -22,   -22,    37,
     -22,   -22,    19,   -22,   -22,    27,    27,    40,     7,   -22,
      27,   -22,    40,    20,   -22
};
...
{
      22,     4,     1,     2,     3,    29,     9,     4,    20,    21,
      31,     9,    29,     4,     1,     2,     3,    30,    20,    21,
       8,    13,    33,    34,    14,     1,     2,     3,    27,    15,
      16,    14,     1,     2,     3,    28,    15,    16,     5,    23,
      32,     1,     2,     3,     1,     2,     3,    24,    25,    21,
       0,    20,    21
};

static const yytype_int8 yycheck[] =
{
      10,     0,     5,     6,     7,    26,     5,     6,    11,    12,
       3,    10,    33,    12,     5,     6,     7,    27,    11,    12,
      11,     0,    32,     3,     4,     5,     6,     7,     9,     9,
      10,     4,     5,     6,     7,    25,     9,    10,     0,     3,
      30,     5,     6,     7,     5,     6,     7,    12,    11,    12,
      -1,    11,    12
};
...
#line 189 "parser.y" /* yacc.c:1646  */
  ...
  Request_header * new_header = (Request_header *)malloc(sizeof(Request_header));
  strcpy(new_header->header_name, (yyvsp[-6].str));
  strcpy(new_header->header_value, (yyvsp[-2].str));
  /*
  ...
  */
  parsing_request->headers[parsing_request->header_count]=new_header;
